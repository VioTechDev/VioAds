    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        originalAdapter = new ListSimpleAdapter(new ListSimpleAdapter.Listener() {
            ...
            public void onRemoveItem(int pos) {
                ...
                Log.d(TAG, "getOriginalPosition: " + adAdapter.getOriginalPosition(pos));
//                adAdapter.getAdapter().notifyDataSetChanged();
    ...
    private void setupAdAdapter() {
        adAdapter = VioAdmob.getInstance().getNativeRepeatAdapter(this, idNative, layoutCustomNative, com.ads.control.R.layout.layout_native_medium,
