...
public class AppOpenMax implements Application.ActivityLifecycleCallbacks, LifecycleObserver {
    ...
    private VioAdmobCallback vioAdmobCallback;
    ...
    public void loadAdResumeMax(Application application, String appOpenAdId) {
        ...
        appOpenAd.setListener(new MaxAdListener() {
            ...
            public void onAdLoadFailed(String adUnitId, MaxError error) {
                Log.d(TAG, "onAdDisplayFailed with error " + error.getMessage());
                dismissDialogLoading();
                if (vioAdmobCallback != null) {
    ...
    public void setAppOpenMaxCallback(VioAdmobCallback vioAdmobCallback) {
        this.vioAdmobCallback = vioAdmobCallback;
    }
    ...
    private void showAdIfReady() {
        ...
        if (ProcessLifecycleOwner.get().getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)
            ...
            if (appOpenAd.isReady()) {
                ...
                appOpenAd.setRevenueListener(ad -> VioLogEventManager.logPaidAdImpression(myApplication, ad, AdType.APP_OPEN));
