...
//    private final Map<String, AppOpenAd> appOpenAdMap = new HashMap<>();
    ...
    public void loadSplashInterstitialAds(final Context context, String id, long timeOut, long timeDelay, AppLovinCallback adListener) {
        ...
        interstitialSplash.setListener(new MaxAdListener() {
            ...
            public void onAdClicked(MaxAd ad) {
                ...
                VioLogEventManager.logClickAdsEvent(context, ad.getAdUnitId());
            }
    ...
    public void onShowSplash(Activity activity, AppLovinCallback adListener) {
        ...
        interstitialSplash.setRevenueListener(ad -> VioLogEventManager.logPaidAdImpression(context,ad, AdType.INTERSTITIAL));
        interstitialSplash.setListener(new MaxAdListener() {
            @Override
            public void onAdLoaded(MaxAd ad) {
            ...
            @Override
            public void onAdClicked(MaxAd ad) {
                VioLogEventManager.logClickAdsEvent(context, interstitialSplash.getAdUnitId());
                if (adListener != null) {
                    adListener.onAdClicked();
                }
                if (disableAdResumeWhenClickAds)
     ...
     * @return
     */
    public MaxInterstitialAd getInterstitialAds(Context context, String id, VioAdmobCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context) || AppLovinHelper.getNumClickAdsPerDay(context, id) >= maxClickAds) {
            Log.d(TAG, "getInterstitialAds: ignore");
            return null;
        }
        ...
        interstitialAd.setListener(new MaxAdListener() {
            ...
            public void onAdLoaded(MaxAd ad) {
                if (callback != null) {
                    ...
                    apInterstitialAd.setMaxInterstitialAd(interstitialAd);
                    callback.onInterstitialLoad(apInterstitialAd);
                }
            }
            ...
            public void onAdLoadFailed(String adUnitId, MaxError error) {
                if (callback != null) {
                    callback.onAdFailedToLoad(new ApAdError(error));
                }
            }
            ...
            public void onAdDisplayFailed(MaxAd ad, MaxError error) {
                if (callback != null) {
                    callback.onAdFailedToShow(new ApAdError(error));
                }
            }
        });
        requestInterstitialAds(interstitialAd);
    ...
    public void showInterstitialAdByTimes(final Context context, MaxInterstitialAd interstitialAd, final AdCallback callback, final boolean shouldReloadAds) {
        ...
        interstitialAd.setRevenueListener(ad -> VioLogEventManager.logPaidAdImpression(context,ad, AdType.INTERSTITIAL));
        interstitialAd.setListener(new MaxAdListener() {
            @Override
            public void onAdLoaded(MaxAd ad) {
    ...
    private void loadBanner(final Activity mActivity, String id, final FrameLayout adContainer, final ShimmerFrameLayout containerShimmer) {
        ...
        adView.setRevenueListener(ad -> VioLogEventManager.logPaidAdImpression( mActivity,ad, AdType.BANNER));
    ...
    public void loadNativeAd(Activity activity, ShimmerFrameLayout containerShimmer, FrameLayout nativeAdLayout, String id, int layoutCustomNative) {
        ...
        nativeAdLoader.setRevenueListener(ad -> VioLogEventManager.logPaidAdImpression( activity,ad, AdType.NATIVE));
    ...
    public void showRewardAd(Activity activity, MaxRewardedAd maxRewardedAd, AppLovinCallback callback) {
        if (maxRewardedAd.isReady()) {
            maxRewardedAd.setRevenueListener(ad -> VioLogEventManager.logPaidAdImpression( activity,ad, AdType.REWARDED));
